...
pymaf_model_dir = 'models/pymaf_model'
CUBE_PARTS_FILE = 'data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = join(pymaf_model_dir, 'J_regressor_extra.npy')
JOINT_REGRESSOR_H36M = 'data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = 'data/vertex_texture.npy'
STATIC_FITS_DIR = 'data/static_fits'
FINAL_FITS_DIR = 'data/final_fits'
SMPL_MEAN_PARAMS = join(pymaf_model_dir, 'smpl_mean_params.npz')
SMPL_MODEL_DIR = pymaf_model_dir
